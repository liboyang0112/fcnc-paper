...
#------------------------------------------------------------------------------
# By default makes ANA-TOPQ-2017-07-PAPER.pdf using target run_pdflatex.
# Replace ANA-TOPQ-2017-07-PAPER with your main filename or add another target set.
...
# Default target - make ANA-TOPQ-2017-07-PAPER.pdf with pdflatex
...
help:
	...
	@echo "make newpaper [BASENAME=ANA-TOPQ-2017-07-PAPER] [TEXLIVE=YYYY]"
	@echo "To create a new ATLAS note draft give the command:"
	@echo "make newnote [BASENAME=ANA-TOPQ-2017-07-PAPER] [TEXLIVE=YYYY]"
	@echo "To create a long document (book) like a TDR:"
	@echo "make newbook [BASENAME=ANA-TOPQ-2017-07-PAPER] [TEXLIVE=YYYY]"
	@echo ""
	...
	@echo "make newpapertexmf|newnotetexmf|newbooktemf [BASENAME=ANA-TOPQ-2017-07-PAPER] [TEXLIVE=YYYY]"
	@echo ""
	@echo "If you need a standalone draft cover give the commands:"
	@echo "make draftcover [BASENAME=ANA-TOPQ-2017-07-PAPER] [TEXLIVE=YYYY]"
	@echo "pdflatex ANA-TOPQ-2017-07-PAPER-draft-cover"
	@echo ""
	@echo "If you need a standalone preprint cover give the commands:"
	@echo "make preprintcover [BASENAME=ANA-TOPQ-2017-07-PAPER] [TEXLIVE=YYYY]"
	@echo "pdflatex ANA-TOPQ-2017-07-PAPER-preprint-cover"
	@echo ""
	@echo "If you need a document for HepData material give the commands:"
	@echo "make newdata [BASENAME=ANA-TOPQ-2017-07-PAPER] [TEXLIVE=YYYY]"
	@echo "pdflatex ANA-TOPQ-2017-07-PAPER-hepdata-main"
	@echo ""
