...
\documentclass[PAPER, coverpage, atlasdraft=true, texlive=2016, UKenglish]{atlasdoc}
...
%-------------------------------------------------------------------------------
% Extra packages:
\usepackage[block=none]{atlaspackage}
...
\input{ANA-TOPQ-2019-17-PAPER-metadata}
...
\input{sections/simulated_samples.tex}
...
\input{sections/background_estimation.tex}

% BDT
\input{sections/bdt_Htautau.tex}
...
\input{sections/tau_FF_appendix}
%\FloatBarrier
\clearpage
