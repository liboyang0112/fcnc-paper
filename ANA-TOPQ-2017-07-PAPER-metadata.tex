...
Standard Model Higgs boson, is presented. 
...
Two analyses are performed searching for top quark pair events in which one top quark decays to $Wb$ and the other top quark decays to $Hq$,
and targeting the $H \to b\bar{b}$ and $H \to \tau^+\tau^-$  decay modes, respectively.  
They exploit either the high multiplicity of $b$-quark jets, or the presence of hadronically decaying tau leptons, and employ different
multivariate techniques to separate the signal from the background, which is dominated by $t\bar{t}$ production.
...
$H \to \tau^+\tau^-$: Xin Chen, Antonio De Maria, Boyang Li, Ligang Xia; \\
