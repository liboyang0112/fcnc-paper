...
//=========  (Fri Jul 20 18:06:44 2018) by ROOT version6.04/14
   TCanvas *c_c1lep6jin4bin_postFit = new TCanvas("c_c1lep6jin4bin_postFit", "c_c1lep6jin4bin_postFit",0,0,600,700);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c_c1lep6jin4bin_postFit->SetHighLightColor(2);
   c_c1lep6jin4bin_postFit->Range(0,0,1,1);
   c_c1lep6jin4bin_postFit->SetFillColor(0);
   c_c1lep6jin4bin_postFit->SetBorderMode(0);
   c_c1lep6jin4bin_postFit->SetBorderSize(2);
   c_c1lep6jin4bin_postFit->SetTickx(1);
   c_c1lep6jin4bin_postFit->SetTicky(1);
   c_c1lep6jin4bin_postFit->SetLeftMargin(0.16);
   c_c1lep6jin4bin_postFit->SetRightMargin(0.05);
   c_c1lep6jin4bin_postFit->SetTopMargin(0.05);
   c_c1lep6jin4bin_postFit->SetBottomMargin(0.16);
   c_c1lep6jin4bin_postFit->SetFrameBorderMode(0);
...
// ------------>Primitives in pad: pad1
   ...
   h_dummy2__73->SetEntries(872927);
   ...
   Graph_Graph_from_h_ratio3033->SetMinimum(0.8855365);
   Graph_Graph_from_h_ratio3033->SetMaximum(1.036463);
   ...
   Graph_g_ratio23034->SetMinimum(0.8954398);
   Graph_g_ratio23034->SetMaximum(1.10456);
   ...
   h_dummy2_copy__74->SetEntries(872927);
...
// ------------>Primitives in pad: pad0
   ...
   h_stack_stack_9->SetMinimum(-0.5268278);
   h_stack_stack_9->SetMaximum(1046.027);
   ...
   c1lep6jin4bin_topEW__76->SetBinContent(1,112.694);
   c1lep6jin4bin_topEW__76->SetBinContent(2,62.46162);
   c1lep6jin4bin_topEW__76->SetBinError(1,15.09507);
   c1lep6jin4bin_topEW__76->SetBinError(2,17.08424);
   c1lep6jin4bin_topEW__76->SetEntries(869380);
   ...
   c1lep6jin4bin_ttbarbb__77->SetBinContent(1,824.0066);
   c1lep6jin4bin_ttbarbb__77->SetBinContent(2,281.5431);
   c1lep6jin4bin_ttbarbb__77->SetBinError(1,25.46517);
   c1lep6jin4bin_ttbarbb__77->SetBinError(2,13.59533);
   c1lep6jin4bin_ttbarbb__77->SetEntries(3441);
   ...
   c1lep6jin4bin_ttbarcc__78->SetBinContent(1,47.56742);
   c1lep6jin4bin_ttbarcc__78->SetBinContent(2,11.51885);
   c1lep6jin4bin_ttbarcc__78->SetBinError(1,3.313798);
   c1lep6jin4bin_ttbarcc__78->SetBinError(2,1.792758);
   c1lep6jin4bin_ttbarcc__78->SetEntries(76);
   ...
   c1lep6jin4bin_ttbarlight__79->SetBinContent(1,12.37516);
   c1lep6jin4bin_ttbarlight__79->SetBinContent(2,9.01702);
   c1lep6jin4bin_ttbarlight__79->SetBinError(1,2.264338);
   c1lep6jin4bin_ttbarlight__79->SetBinError(2,2.670068);
   c1lep6jin4bin_ttbarlight__79->SetEntries(28);
   ...
   c1lep6jin4bin_uHcW__80->SetBinContent(1,-0.426646);
   c1lep6jin4bin_uHcW__80->SetBinContent(2,-0.4405432);
   c1lep6jin4bin_uHcW__80->SetBinError(1,0.1001818);
   c1lep6jin4bin_uHcW__80->SetBinError(2,0.07989393);
   c1lep6jin4bin_uHcW__80->SetEntries(378);
   ...
   Double_t g_totErr_postFit_fx3035[2] = {
   0.25,
   0.75};
   Double_t g_totErr_postFit_fy3035[2] = {
   996.6431,
   364.5406};
   Double_t g_totErr_postFit_felx3035[2] = {
   0.25,
   0.25};
   Double_t g_totErr_postFit_fely3035[2] = {
   59.64222,
   31.76371};
   Double_t g_totErr_postFit_fehx3035[2] = {
   0.25,
   0.25};
   Double_t g_totErr_postFit_fehy3035[2] = {
   59.64222,
   31.76371};
   grae = new TGraphAsymmErrors(2,g_totErr_postFit_fx3035,g_totErr_postFit_fy3035,g_totErr_postFit_felx3035,g_totErr_postFit_fehx3035,g_totErr_postFit_fely3035,g_totErr_postFit_fehy3035);
   ...
   TH1F *Graph_g_totErr_postFit3035 = new TH1F("Graph_g_totErr_postFit3035","FcncDiscriminant",100,0,1.1);
   Graph_g_totErr_postFit3035->SetMinimum(260.4261);
   Graph_g_totErr_postFit3035->SetMaximum(1128.636);
   ...
   h_dummy_copy__81->SetEntries(872927);
...
tex->SetNDC();
   ...
   entry=leg->AddEntry("c1lep6jin4bin_uHcW","t#bar{t}#rightarrowWbHc","f");
   ...
   pad0->Modified();
   c_c1lep6jin4bin_postFit->cd();
   c_c1lep6jin4bin_postFit->Modified();
   c_c1lep6jin4bin_postFit->cd();
   c_c1lep6jin4bin_postFit->SetSelected(c_c1lep6jin4bin_postFit);
}
