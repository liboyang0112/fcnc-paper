void c1lep5jex4bin_postFit()
{
//=========Macro generated from canvas: c_c1lep5jex4bin_postFit/c_c1lep5jex4bin_postFit
//=========  (Fri Jul 20 11:23:10 2018) by ROOT version6.04/14
   TCanvas *c_c1lep5jex4bin_postFit = new TCanvas("c_c1lep5jex4bin_postFit", "c_c1lep5jex4bin_postFit",0,0,600,700);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c_c1lep5jex4bin_postFit->SetHighLightColor(2);
   c_c1lep5jex4bin_postFit->Range(0,0,1,1);
   c_c1lep5jex4bin_postFit->SetFillColor(0);
   c_c1lep5jex4bin_postFit->SetBorderMode(0);
   c_c1lep5jex4bin_postFit->SetBorderSize(2);
   c_c1lep5jex4bin_postFit->SetTickx(1);
   c_c1lep5jex4bin_postFit->SetTicky(1);
   c_c1lep5jex4bin_postFit->SetLeftMargin(0.16);
   c_c1lep5jex4bin_postFit->SetRightMargin(0.05);
   c_c1lep5jex4bin_postFit->SetTopMargin(0.05);
   c_c1lep5jex4bin_postFit->SetBottomMargin(0.16);
   c_c1lep5jex4bin_postFit->SetFrameBorderMode(0);
...
// ------------>Primitives in pad: pad1
   ...
   h_dummy2__46->SetEntries(1221485);
   ...
   h_dummy2__46->GetYaxis()->SetTitle("Data / Pred");
   h_dummy2__46->GetYaxis()->CenterTitle(true);
   ...
   Graph_Graph_from_h_ratio3021->SetMinimum(0.806656);
   Graph_Graph_from_h_ratio3021->SetMaximum(1.119441);
   ...
   Graph_g_ratio23022->SetMinimum(0.8638063);
   Graph_g_ratio23022->SetMaximum(1.136194);
   ...
   h_dummy2_copy__47->SetEntries(1221485);
   ...
   h_dummy2_copy__47->GetYaxis()->SetTitle("Data / Pred");
   h_dummy2_copy__47->GetYaxis()->CenterTitle(true);
...
// ------------>Primitives in pad: pad0
   ...
   h_dummy__48->SetEntries(1221485);
   ...
   h_dummy__48->GetYaxis()->SetTitle("Events / 0.5");
   ...
   h_stack_stack_6->SetMinimum(-0.3625213);
   h_stack_stack_6->SetMaximum(345.0739);
   ...
   c1lep5jex4bin_topEW__49->SetBinContent(1,36.17019);
   c1lep5jex4bin_topEW__49->SetBinContent(2,17.86483);
   c1lep5jex4bin_topEW__49->SetBinError(1,3.703205);
   c1lep5jex4bin_topEW__49->SetBinError(2,4.634347);
   c1lep5jex4bin_topEW__49->SetEntries(1220428);
   ...
   c1lep5jex4bin_ttbarbb__50->SetBinContent(1,267.2641);
   c1lep5jex4bin_ttbarbb__50->SetBinContent(2,88.83695);
   c1lep5jex4bin_ttbarbb__50->SetBinError(1,12.53801);
   c1lep5jex4bin_ttbarbb__50->SetBinError(2,7.417536);
   c1lep5jex4bin_ttbarbb__50->SetEntries(992);
   ...
   c1lep5jex4bin_ttbarcc__51->SetBinContent(1,20.36594);
   c1lep5jex4bin_ttbarcc__51->SetBinContent(2,19.11843);
   c1lep5jex4bin_ttbarcc__51->SetBinError(1,3.089406);
   c1lep5jex4bin_ttbarcc__51->SetBinError(2,3.937104);
   c1lep5jex4bin_ttbarcc__51->SetEntries(40);
   ...
   c1lep5jex4bin_ttbarlight__52->SetBinContent(1,4.967127);
   c1lep5jex4bin_ttbarlight__52->SetBinContent(2,10.86376);
   c1lep5jex4bin_ttbarlight__52->SetBinError(1,1.394398);
   c1lep5jex4bin_ttbarlight__52->SetBinError(2,3.160271);
   c1lep5jex4bin_ttbarlight__52->SetEntries(23);
   ...
   c1lep5jex4bin_uHcW__53->SetBinContent(1,-0.1255563);
   c1lep5jex4bin_uHcW__53->SetBinContent(2,-0.2838103);
   c1lep5jex4bin_uHcW__53->SetBinError(1,0.06069765);
   c1lep5jex4bin_uHcW__53->SetBinError(2,0.07871095);
   c1lep5jex4bin_uHcW__53->SetEntries(201);
   ...
   Double_t g_totErr_postFit_fx3023[2] = {
   0.25,
   0.75};
   Double_t g_totErr_postFit_fy3023[2] = {
   328.7674,
   136.684};
   Double_t g_totErr_postFit_felx3023[2] = {
   0.25,
   0.25};
   Double_t g_totErr_postFit_fely3023[2] = {
   23.83549,
   15.51291};
   Double_t g_totErr_postFit_fehx3023[2] = {
   0.25,
   0.25};
   Double_t g_totErr_postFit_fehy3023[2] = {
   23.83549,
   15.51291};
   grae = new TGraphAsymmErrors(2,g_totErr_postFit_fx3023,g_totErr_postFit_fy3023,g_totErr_postFit_felx3023,g_totErr_postFit_fehx3023,g_totErr_postFit_fely3023,g_totErr_postFit_fehy3023);
   ...
   TH1F *Graph_g_totErr_postFit3023 = new TH1F("Graph_g_totErr_postFit3023","FcncDiscriminant",100,0,1.1);
   Graph_g_totErr_postFit3023->SetMinimum(98.02787);
   Graph_g_totErr_postFit3023->SetMaximum(375.7461);
   Graph_g_totErr_postFit3023->SetDirectory(0);
   Graph_g_totErr_postFit3023->SetStats(0);
   Graph_g_totErr_postFit3023->SetLineWidth(2);
   Graph_g_totErr_postFit3023->SetMarkerStyle(20);
   Graph_g_totErr_postFit3023->SetMarkerSize(1.2);
   Graph_g_totErr_postFit3023->GetXaxis()->SetLabelFont(43);
   Graph_g_totErr_postFit3023->GetXaxis()->SetLabelSize(21);
   Graph_g_totErr_postFit3023->GetXaxis()->SetTitleSize(21);
   Graph_g_totErr_postFit3023->GetXaxis()->SetTitleOffset(1.4);
   Graph_g_totErr_postFit3023->GetXaxis()->SetTitleFont(43);
   Graph_g_totErr_postFit3023->GetYaxis()->SetLabelFont(43);
   Graph_g_totErr_postFit3023->GetYaxis()->SetLabelSize(21);
   Graph_g_totErr_postFit3023->GetYaxis()->SetTitleSize(21);
   Graph_g_totErr_postFit3023->GetYaxis()->SetTitleOffset(1.4);
   Graph_g_totErr_postFit3023->GetYaxis()->SetTitleFont(43);
   Graph_g_totErr_postFit3023->GetZaxis()->SetLabelFont(43);
   Graph_g_totErr_postFit3023->GetZaxis()->SetLabelSize(21);
   Graph_g_totErr_postFit3023->GetZaxis()->SetTitleSize(21);
   Graph_g_totErr_postFit3023->GetZaxis()->SetTitleFont(43);
   grae->SetHistogram(Graph_g_totErr_postFit3023);
   ...
   h_dummy_copy__54->SetEntries(1221485);
   ...
   h_dummy_copy__54->GetYaxis()->SetTitle("Events / 0.5");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.18,0.73,"5j, #geq4b");
tex->SetNDC();
   tex->SetTextFont(43);
   tex->SetTextSize(21);
   tex->SetLineWidth(2);
...
tex->SetNDC();
   ...
   entry=leg->AddEntry("c1lep5jex4bin_uHcW","t#bar{t}#rightarrowWbHc","f");
   ...
   entry->SetTextFont(43);
   entry=leg->AddEntry("c1lep5jex4bin_ttbarlight","t#bar{t}+light-jets","f");
   entry->SetFillStyle(1001);
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(43);
   entry=leg->AddEntry("c1lep5jex4bin_ttbarcc","t#bar{t}+#geq1c","f");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(43);
   entry=leg->AddEntry("c1lep5jex4bin_ttbarbb","t#bar{t}+#geq1b","f");
   ...
   pad0->Modified();
   c_c1lep5jex4bin_postFit->cd();
   c_c1lep5jex4bin_postFit->Modified();
   c_c1lep5jex4bin_postFit->cd();
   c_c1lep5jex4bin_postFit->SetSelected(c_c1lep5jex4bin_postFit);
}
