...
// ------------>Primitives in pad: pad1
   ...
   h_dummy2__64->GetYaxis()->SetTitle("Data / Pred");
   h_dummy2__64->GetYaxis()->CenterTitle(true);
   ...
   h_dummy2_copy__65->GetYaxis()->SetTitle("Data / Pred");
   h_dummy2_copy__65->GetYaxis()->CenterTitle(true);
