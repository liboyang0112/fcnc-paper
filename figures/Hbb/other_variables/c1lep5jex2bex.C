...
// ------------>Primitives in pad: pad0
   ...
   h_dummy__30->GetYaxis()->SetTitle("Events");
   ...
   h_dummy_copy__36->GetYaxis()->SetTitle("Events");
...
tex->SetNDC();
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.18,0.73,"5jex-2bex");
tex->SetNDC();
   tex->SetTextFont(43);
   tex->SetTextSize(21);
   tex->SetLineWidth(2);
...
tex->SetNDC();
   ...
   entry->SetTextFont(43);
   entry=leg->AddEntry("c1lep5jex2bex_ttbarlight","t#bar{t}+light","f");
   entry->SetFillStyle(1001);
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(43);
   entry=leg->AddEntry("c1lep5jex2bex_ttbarcc","t#bar{t}+cc","f");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(43);
   entry=leg->AddEntry("c1lep5jex2bex_ttbarbb","t#bar{t}+bb","f");
