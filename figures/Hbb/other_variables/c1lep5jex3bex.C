...
// ------------>Primitives in pad: pad0
   ...
   h_dummy__39->GetYaxis()->SetTitle("Events");
   ...
   h_dummy_copy__45->GetYaxis()->SetTitle("Events");
...
tex->SetNDC();
   ...
   entry->SetTextFont(43);
   entry=leg->AddEntry("c1lep5jex3bex_ttbarlight","t#bar{t}+light","f");
   entry->SetFillStyle(1001);
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(43);
   entry=leg->AddEntry("c1lep5jex3bex_ttbarcc","t#bar{t}+cc","f");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(43);
   entry=leg->AddEntry("c1lep5jex3bex_ttbarbb","t#bar{t}+bb","f");
