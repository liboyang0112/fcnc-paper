...
%DIF -------
\AtlasTitle{Search for flavour-changing neutral current interactions of the top quark and the Higgs boson which decays into a pair of $\tau$-leptons in pp collisions at $\sqrt{s}=13~\tev$ with the ATLAS detector\vspace{-0.1em}} %DIF > 
%DIF -------
...
%The Higgs boson decays into a pair of $\tau$-leptons, $H\rightarrow \tau^+\tau^-$, is considered.
...
%top quark with FCNC decay of $t\rightarrow qH$. 
...
%No significant excess of events above the background expectation is found,
A slight excess of data is observed above the expected SM background with a significance of 2.6$\sigma$,
...
direction of the electron (muon). The electron (muon) candidates are required to satisfy both \DIFdelbegin \DIFdel{$I_R/\pt^\ell < 0.2~(0.3)$ and $E_R/\pt^\ell < 0.2~(0.3)$.
}\DIFdelend \DIFaddbegin \DIFadd{$I_R/\pt^l < 0.2~(0.3)$ and $E_R/\pt^l < 0.2~(0.3)$.
%DIF > $I_R/\pt^\ell < 0.2~(0.3)$ and $E_R/\pt^\ell < 0.2~(0.3)$.
}\DIFaddend 
...
\begin{itemize}
\item $t_h\lephad$: Targeting $t_hH$ and $t_ht(qH)$ with $H\to\lephad$ decay. Exactly one $\had$ with opposite-side charge to $\tau_l$ is required, including at least three jets with exactly one $b$-jet.
\item $t_l\hadhad$: Targeting $t_lH$ and $t_lt(qH)$ with $H\to\hadhad$ decay. Exactly one lepton and two opposite-sign $\had$ are selected, including at least 1 jet with exactly one $b$-jet.
...
\begin{itemize}
\item $t_h\hadhad$: Targeting $t_hH$ and $t_ht(qH)$ with $H\to\hadhad$ decay. Exactly two $\had$ with opposite-sign charge are selected, including at least 3 jet with exactly one $b$-jet.
\end{itemize}
...
%DIF >    \multirow{7}{*}{SR}&$t_l\thadhad$     & 1     & any                                & 1      & 2             & $\thadhad$ OS\\ \cline{2-7}
%DIF >    &$t_l\tauhad$-1j  & 1     & 1                                   & 1      & 1                     & $t_l\tauhad$ SS\\ \cline{2-7}
%DIF >    &$t_l\tauhad$-2j  & 1     & 2                                        & 1      & 1                     & $t_l\tauhad$ SS\\ \cline{2-7}
...
%DIF >    \multirow{6}{*}{CRtt}&$t_lt_l1b\tauhad$ & 1     & any                           & 2      & 1                     & $t_lt_l$ OS\\ \cline{2-7}
%DIF >    &$t_lt_l2b\tauhad$      & 2     & any                           & 2      & 1                     & $t_lt_l$ OS\\ \cline{2-7}
%DIF >    &$t_lt_h2b\tauhad$-2jSS & 2     & 2                             & 1      & 1             & $t_l\tauhad$ SS\\ \cline{2-7}
%DIF >    &$t_lt_h2b\tauhad$-2jOS & 2     & 2                             & 1      & 1             & $t_l\tauhad$ OS\\ \cline{2-7}
%DIF >    &$t_lt_h2b\tauhad$-3jSS & 2     & $\ge3$                        & 1      & 1             & $t_l\tauhad$ SS\\ \cline{2-7}
%DIF >    &$t_lt_h2b\tauhad$-3jOS & 2     & $\ge3$                & 1      & 1             & $t_l\tauhad$ OS\\ \hline
%DIF >    \end{tabular}
%DIF >    \end{table}
\DIFaddbegin 
...
\label{tab:importance}
 ...
 \text{\DIFdelbeginFL \DIFdelFL{Min}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{min}\DIFaddendFL }(\DIFdelbeginFL \DIFdelFL{$m_{\tau\tau \text{q-jet}}$}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$m_{\tau\tau j/g}$}\DIFaddendFL )             & $9$       &             &  $3$              &  & $14$          &  &         \\
...
\item \text{\DIFdelbegin \DIFdel{Min}\DIFdelend \DIFaddbegin \DIFadd{min}\DIFaddend }(\DIFdelbegin \DIFdel{$M_{\tau\tau \text{q-jet}}$}\DIFdelend \DIFaddbegin \DIFadd{$m_{\tau\tau j/q}$}\DIFaddend ) is the visible mass of the di-tau candidates (include leptonic tau) and the light-flavor jet, minimized by choosing different jet, reflects the invariant masss of the visible FCNC top decaying product, an alternative to variable $m_{\text{t},\text{FCNC},\text{vis}}$.
\item \text{\DIFdelbegin \DIFdel{Min}\DIFdelend \DIFaddbegin \DIFadd{min}\DIFaddend }(\DIFdelbegin \DIFdel{$M_{\text{light-jet},\text{light-jet}}$}\DIFdelend \DIFaddbegin \DIFadd{$m_{jj}$}\DIFaddend ) is the invariant mass of two light-flavor jets, minimized by choosing different jets, reflects the invariant mass of the W candidate.
...
\DIFdelendFL \DIFaddbeginFL \includegraphics[page=1,width=0.33\textwidth]{figures/new_pt/reg1l1tau1b2j_os.pdf}\DIFaddendFL &
...
\DIFdelendFL \DIFaddbeginFL \includegraphics[page=1,width=0.33\textwidth]{figures/new_pt/reg2mtau1b3jos_vetobtagwp70_highmet.pdf}\DIFaddendFL &\\
...
Most background processes are modelled using \DIFdelbegin \DIFdel{Monte Carlo (MC ) }\DIFdelend \DIFaddbegin \DIFadd{MC }\DIFaddend simulation.
...
control regions (\DIFdelbegin \DIFdel{$CR_{tt}$}\DIFdelend \DIFaddbegin \DIFadd{CRtt}\DIFaddend ) using dileptonic decays of $t\bar t$ events and semileptonic decays of $t\bar t$ events with two
...
that the subleading $\had$ candidate is required to fail the medium $\had$ identification\DIFdelbegin \DIFdel{(Loose)}\DIFdelend \DIFaddbegin \DIFadd{, but it still passes a loose requirement}\DIFaddend .
The contribution of fakes with subleading $\had$ candidate can be calculated by rescaling the templates of \DIFdelbegin \DIFdel{Loose }\DIFdelend \DIFaddbegin \DIFadd{loose }\DIFaddend taus in the CR
with \DIFdelbegin \DIFdel{proper }\DIFdelend fake factors (FF).
...
the ratio of the Data-MC ($\mathrm{real~tau}$) yields \DIFdelbegin \DIFdel{passing to failing the }\DIFdelend \DIFaddbegin \DIFadd{in which the $\had$ candidate is passed or failed the }\DIFaddend medium tau ID \DIFaddbegin \DIFadd{selection
}\DIFaddend in the $W$+jets control region.
\DIFdelbegin \DIFdel{We have compared
FF }\DIFdelend %DIF > passing to failing the medium tau ID in the $W$+jets control region.
%DIF > We have compared
\DIFaddbegin \DIFadd{FFs }\DIFaddend obtained from the $W$+jets and \DIFaddbegin \DIFadd{from }\DIFaddend the same-sign $\thadhad$ control regions \DIFaddbegin \DIFadd{are compared }\DIFaddend and the differences are treated as a systematic uncertainty.

\subsection{Background with fake light leptons}
The background originating from non-prompt or misidentified light leptons is primarily from the \DIFdelbegin \DIFdel{QCD }\DIFdelend multi-jet production.
...
%However the multi-jet background has large event rate and can contribute with both electron or muon and $\had$ faked, especially to $t_l\had$ where the fake-lepton dominates. and the jet multiplicity is low.
...
$t_l\had$ channels where the fake light leptons are important\DIFdelbegin \DIFdel{while }\DIFdelend \DIFaddbegin \DIFadd{, while they are }\DIFaddend negligible in other leptonic channels. 
...
A slight excess of data is observed above background with a significance of 2.6 $\sigma$, which is mainly in the most sensitive $t_l\thadhad$ channel in the high BDT score region.
\DIFdelbegin \DIFdel{We have checked the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend kinematic distributions for the observed excess in
...
%DIF >  (a1) BDT in $t_l\thadhad$ & (a2) BDT in  $t_l\tauhad$-1j& (a3) BDT in $t_l\tauhad$-2j\\
...
%DIF >  \end{tabular}
%DIF >  \caption{ The BDT output distributions are fitted with background only to the data: $t_l\thadhad$ (a1),  $t_l\tauhad$-1j (a2),  $t_l\tauhad$-2j (a3),
...
(a1) BDT in $t_l\thadhad$ & (a2) BDT in  $t_l\tauhad$-1j& (a3) BDT in $t_l\tauhad$-2j\\
...
\end{tabular}
\caption{ The BDT output distributions are fitted with S+B to the data in \DIFdelbeginFL \DIFdelFL{$tcH$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$tuH$ }\DIFaddendFL search: $t_l\thadhad$ (a1),  $t_l\tauhad$-1j (a2),  $t_l\tauhad$-2j (a3),
...
(c1) BDT in$t_h\thadhad$-3j\\
\end{tabular}
\caption{ The BDT output distributions are fitted with S+B to the data in \DIFdelbeginFL \DIFdelFL{$tuH$ }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$tcH$ }\DIFaddendFL search: $t_l\thadhad$ (a1),  $t_l\tauhad$-1j (a2),  $t_l\tauhad$-2j (a3),
  $t_h\tlhad$-2j (b1), $t_h\tlhad$-3j (b2), $t_h\thadhad$-2j (b3), and $t_h\thadhad$-3j (c1). Statistical and systematic uncertainties are shown.}
...
affecting the normalization and factorization scales, $b$-tagging, the choice of parton shower and hadronization for $t\bar t$ modelling, and the fake $\had$ background estimation in the hadronic channels. Their relative impacts on the signal strength are summarized in Tables~\ref{tab:had_sys_impact}.
...
\caption{\DIFaddFL{List of relative uncertainties on the upper limits of $\BR(t\to qH)$ ($q=u,c$) obtained from the combined fit. The uncertainties are symmetrised for\
...
\begin{tabular}{cccc} \toprule\toprule
                    & \DIFadd{$t_h\thadhad$-2j }& \DIFadd{$t_h\thadhad$-3j }& \DIFadd{Combination  }\\\midrule
\DIFadd{$t\to cH$           }& \DIFadd{$-1.03^{+1.04}_{-1.04} $ }& \DIFadd{$0.16^{+0.47}_{-0.47} $  }& \DIFadd{$0.11^{+0.43}_{-0.43}$  }\\
\DIFadd{$t\to uH$           }& \DIFadd{$-0.55^{+0.59}_{-0.59}$ }& \DIFadd{$0.14^{+0.40}_{-0.40} $  }&  \DIFadd{$0.04^{+0.34}_{-0.34}$  }\\
\bottomrule\bottomrule\\
\end{tabular}

\centering
\begin{tabular}{ccccccc} \toprule\toprule
& \DIFadd{$t_l\tauhad$-2j }& \DIFadd{$t_l\tauhad$-1j }& \DIFadd{$t_h\tlhad$-2j}& \DIFadd{$t_h\tlhad$-3j }& \DIFadd{$t_l\thadhad$ }& \DIFadd{Combination}\\\midrule
\DIFadd{$t\to cH$          }& \DIFadd{$0.81^{2.04}_{-2.04} $ }& \DIFadd{$0.40^{1.70}_{-1.70} $ }& \DIFadd{$-1.36^{2.56}_{-2.56} $ }& \DIFadd{$-0.04^{1.26}_{-1.26} $ }& \DIFadd{$0.74^{0.34}_{-0.34} $ }& \DIFadd{$0.68^{0.32}_{-0.32} $}\\
\DIFadd{$t\to uH$          }& \DIFadd{$0.57^{1.66}_{-1.66} $ }& \DIFadd{$0.31^{1.33}_{-1.33} $ }& \DIFadd{$-0.66^{1.38}_{-1.38} $ }& \DIFadd{$-0.04^{0.98}_{-0.98} $ }& \DIFadd{$ 0.53^{0.25}_{-0.25}$ }& \DIFadd{$0.48^{0.23}_{-0.23} $}\\
\bottomrule\bottomrule\\
\end{tabular}
...
\centering
\begin{tabular}{cccc} \toprule\toprule
                    & \DIFadd{hadronic }& \DIFadd{hadronic }& \DIFadd{Combination  }\\\midrule
\DIFadd{$t\to cH$           }& \DIFadd{$0.11^{+0.43}_{-0.43}$ }& \DIFadd{$0.68^{0.32}_{-0.32}$  }& \DIFadd{$0.51^{+0.25}_{-0.25} $  }\\
\DIFadd{$t\to uH$           }& \DIFadd{$0.04^{+0.34}_{-0.34}$ }& \DIFadd{$0.48^{0.23}_{-0.23}$  }& \DIFadd{$0.37^{+0.18}_{-0.18} $  }\\
\bottomrule\bottomrule\\
\end{tabular}
...
%DIF > $\mathcal{B}(\bar{t}t\to bWcH)[10^{-3}]$     & $2.09$  ($3.15^{+1.44}_{-0.88}$ ) & $1.23$  ($1.10^{+0.52}_{-0.31}$  )  & $1.10$ ($1.03^{+0.48}_{-0.29}$ )\\
%DIF > $\mathcal{B}(cg\to tH)[10^{-3}]$             & $13.74$ ($20.99^{+9.88}_{-5.87}$) & $31.36$ ($29.22^{+13.60}_{-8.16}$)  & $13.20$($17.23^{+7.99}_{-4.82}$)\\
\DIFadd{$\mathcal{B}(t\to cH)$             }& \DIFadd{$1.85 \times 10^{-3}$  ($2.80^{+1.30}_{-0.78} \times 10^{-3} $ ) }& \DIFadd{$1.18 \times 10^{-3}$  ($1.06^{+0.50}_{-0.30} \times 10^{-3}$  )  }& \DIFadd{$1.04 \times 10^{-3}$ ($9.8^{+4.6}_{-2.8} \times 10^{-4}$ )}\\
%DIF > $\mathcal{B}(\bar{t}t\to bWuH)[10^{-3}]$     & $1.97$  ($3.08^{+1.41}_{-0.86}$ ) & $1.18$  ($1.05^{+0.50}_{-0.29}$  )  & $1.05$ ($0.99^{+0.47}_{-0.28}$ )\\
%DIF > $\mathcal{B}(ug\to tH)[10^{-3}]$             & $2.32$  ($3.29^{+1.55}_{-0.92}$ ) & $6.47$  ($5.97^{+2.87}_{-1.67}$  )  & $2.31$ ($2.95^{+1.37}_{-0.82}$ )\\
\DIFadd{$\mathcal{B}(t\to uH)$    }& \DIFadd{$1.10 \times 10^{-3}$  ($1.65^{+0.79}_{-0.46} \times 10^{-3}$ ) }& \DIFadd{$1.00 \times 10^{-3}$  ($8.9^{+4.2}_{-2.5} \times 10^{-4}$  )  }& \DIFadd{$7.8 \times 10^{-4}$ ($7.8^{+3.7}_{-2.2} \times 10^{-4}$ )}\\
\bottomrule\bottomrule\\
\end{tabular}
...
\begin{tabular}{cccc} \toprule\toprule
                    & \DIFadd{$t_h\thadhad$-2j }& \DIFadd{$t_h\thadhad$-3j }& \DIFadd{Combination}\\\midrule
%DIF > $\bar{t}t\to bWcH$ & $-0.96$($0.69$) & $0.34$($1.82$)& $0.30$ ($1.93$)\\
%DIF > $cg\to tH$         & $-0.97$($0.11$) & $0.23$($0.08$)& $-0.62$($0.13$)\\
\DIFadd{$t\to cH$           }& \DIFadd{$-0.96$($0.78$) }& \DIFadd{$0.34$($1.87$)}& \DIFadd{$0.26$ ($1.99$)}\\
%DIF > $\bar{t}t\to bWuH$ & $-1.10$($0.70$) & $0.38$($1.88$)& $0.30$ ($1.98$)\\
%DIF > $ug\to tH$         & $-0.70$($0.69$) & $0.24$($0.37$)& $-0.49$($0.75$)\\
\DIFadd{$t\to uH$           }& \DIFadd{$-0.90$($1.25$) }& \DIFadd{$0.36$($2.13$)}& \DIFadd{$0.11$ ($2.33$)}\\
\bottomrule\bottomrule\\
\end{tabular}
...
\centering
\begin{tabular}{cccc} \toprule\toprule
 & \DIFadd{$t_l\tauhad$-2j }& \DIFadd{$t_l\tauhad$-1j }& \DIFadd{$t_h\tlhad$-2j}\\\midrule
%DIF > $\mathcal{B}(\bar{t}t\to bWcH)[10^{-3}]$              & $5.05$  ($4.50^{+2.00}_{-1.26}$  ) & $4.21$ ($3.93^{+1.88}_{-1.10}$   )& $5.70$ ($6.96^{+3.55}_{-1.94}$   ) \\
%DIF > $\mathcal{B}(cg\to tH)[10^{-3}]$              &  /      ( /                      ) & $94.02$($87.83^{+38.39}_{-24.54}$)& $31.44$($37.31^{+16.71}_{-10.43}$) \\
\DIFadd{$\mathcal{B}(t\to cH)$              }& \DIFadd{$4.86 \times 10^{-3}$  ($4.32^{+1.89}_{-1.21} \times 10^{-3}$  ) }& \DIFadd{$3.94 \times 10^{-3}$ ($3.67^{+1.66}_{-1.03} \times 10^{-3}$   )}& \DIFadd{$4.81 \times 10^{-3}$ ($5.85^{+2.90}_{-1.63} \times 10^{-3}$   ) }\\
%DIF > $\mathcal{B}(\bar{t}t\to bWuH)[10^{-3}]$              & $4.66$  ($4.22^{+1.91}_{-1.18}$  ) & $3.86$ ($3.58^{+1.75}_{-1.00}$   )& $5.51$ ($6.75^{+3.27}_{-1.89}$   ) \\
%DIF > $\mathcal{B}(ug\to tH)[10^{-3}]$              & $27.95$ ($24.29^{+10.55}_{-6.79}$) & $17.90$($16.88^{+7.49}_{-4.72}$  )& $4.78$ ($5.53^{+2.48}_{-1.55}$   ) \\
\DIFadd{$\mathcal{B}(t\to uH)$              }& \DIFadd{$3.93 \times 10^{-3}$  ($3.55^{+1.56}_{-0.99} \times 10^{-3}$  ) }& \DIFadd{$3.10 \times 10^{-3}$ ($2.87^{+1.29}_{-0.80} \times 10^{-3}$   )}& \DIFadd{$2.56 \times 10^{-3}$ ($3.05^{+1.38}_{-0.85} \times 10^{-3}$   ) }\\
\bottomrule\bottomrule\\    
\end{tabular}
\begin{tabular}{cccc} \toprule\toprule
 & \DIFadd{$t_h\tlhad$-3j }& \DIFadd{$t_l\thadhad$ }& \DIFadd{Combined}\\\midrule
%DIF > $\mathcal{B}(\bar{t}t\to bWcH)[10^{-3}]$         &$3.04$ ($3.03^{+1.57}_{-0.85}$   ) & $1.54$ ($0.68^{+0.32}_{-0.19}$) & $1.42$ ($0.65^{+0.30}_{-0.18}$)\\
%DIF > $\mathcal{B}(cg\to tH)[10^{-3}]$         &$48.46$($49.53^{+24.82}_{-13.84}$) & $18.92$($8.26^{+4.27}_{-2.31}$) & $16.92$($7.81^{+3.94}_{-2.18}$)\\
\DIFadd{$\mathcal{B}(t\to cH)$         }&\DIFadd{$2.78 \times 10^{-3}$ ($2.79^{+1.36}_{-0.78} \times 10^{-3}$   ) }& \DIFadd{$1.41 \times 10^{-3}$ ($0.63^{+0.29}_{-0.18} \times 10^{-3}$) }& \DIFadd{$1.29 \times 10^{-3}$ ($0.59^{+0.27}_{-0.17} \times 10^{-3}$)}\\
%DIF > $\mathcal{B}(\bar{t}t\to bWuH)[10^{-3}]$         &$2.97$ ($2.98^{+1.51}_{-0.83}$   ) & $1.45$ ($0.64^{+0.32}_{-0.18}$) & $1.33$ ($0.61^{+0.30}_{-0.17}$)\\
%DIF > $\mathcal{B}(ug\to tH)[10^{-3}]$         &$8.72$ ($9.00^{+4.98}_{-2.51}$   ) & $3.93$ ($1.72^{+0.94}_{-0.48}$) & $3.29$ ($1.58^{+0.82}_{-0.44}$)\\
\DIFadd{$\mathcal{B}(t\to uH)$         }&\DIFadd{$2.07 \times 10^{-3}$ ($2.09^{+0.94}_{-0.58} \times 10^{-3}$   ) }& \DIFadd{$1.01 \times 10^{-3}$ ($4.5^{+2.1}_{-1.3} \times 10^{-4}$) }& \DIFadd{$9.2 \times 10^{-4}$ ($4.2^{+1.9}_{-1.2} \times 10^{-4}$)}\\
\bottomrule\bottomrule\\
\end{tabular}
...
\begin{tabular}{cccc} \toprule\toprule
 & \DIFadd{$t_l\tauhad$-2j }& \DIFadd{$t_l\tauhad$-1j }& \DIFadd{$t_h\tlhad$-2j}\\\midrule
%DIF > $\bar{t}t\to bWcH$ & $0.39$($0.46$) & $0.24$($0.55$) & $-0.53$($0.33$) \\
%DIF > $cg\to tH$         &  /    ( /    ) & $0.23$($0.03$) & $-0.48$($0.06$) \\
\DIFadd{$t\to cH$          }& \DIFadd{$0.40$($0.48$) }& \DIFadd{$0.24$($0.57$) }& \DIFadd{$-0.52$($0.39$) }\\
%DIF > $\bar{t}t\to bWuH$ & $0.33$($0.50$) & $0.25$($0.61$) & $-0.55$($0.33$) \\
%DIF > $ug\to tH$         & $0.46$($0.09$) & $0.20$($0.12$) & $-0.41$($0.39$) \\
\DIFadd{$t\to uH$          }& \DIFadd{$0.34$($0.58$) }& \DIFadd{$0.24$($0.73$) }& \DIFadd{$-0.48$($0.69$) }\\
\bottomrule\bottomrule\\
\end{tabular}
\begin{tabular}{cccc} \toprule\toprule
 & \DIFadd{$t_h\tlhad$-3j }& \DIFadd{$t_l\thadhad$ }& \DIFadd{Combined}\\\midrule
%DIF > $\bar{t}t\to bWcH$  & $-0.03$($0.72$) &  $2.65$($3.04$) & $2.60$($3.14$)  \\
%DIF > $cg\to tH$          & $-0.08$($0.05$) &  $2.57$($0.31$) & $2.53$($0.32$)  \\
\DIFadd{$t\to cH$            }& \DIFadd{$-0.04$($0.76$) }&  \DIFadd{$2.64$($3.24$) }& \DIFadd{$2.59$($3.34$)  }\\
%DIF > $\bar{t}t\to bWuH$  & $-0.03$($0.73$) &  $2.67$($3.22$) & $2.63$($3.31$)  \\
%DIF > $ug\to tH$          & $-0.10$($0.27$) &  $2.55$($1.54$) & $2.43$($1.62$)  \\
\DIFadd{$t\to uH$            }& \DIFadd{$-0.05$($0.98$) }&  \DIFadd{$2.64$($4.08$) }& \DIFadd{$2.59$($4.23$)  }\\
\bottomrule\bottomrule\\
\end{tabular}
...
\DIFaddbegin \centering
\begin{tabular}{ccc} \toprule\toprule
 & \DIFadd{$t\to cH$ }& \DIFadd{$t\to uH$}\\\midrule
\DIFadd{Combined Sigificance }& \DIFadd{$2.34$($3.69$) }& \DIFadd{$2.31$($4.49$)}\\
\bottomrule\bottomrule\\
\end{tabular}
