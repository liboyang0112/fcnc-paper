...
\DIFdelendFL \\
%(b1) BDT in $t_h\tlhad$-2j & (b2) BDT in  $t_h\tlhad$-3j & (b3) BDT in $t_h\thadhad$-2j \\
(\DIFdelbeginFL \DIFdelFL{b1}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{d}\DIFaddendFL ) & (\DIFdelbeginFL \DIFdelFL{b2}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{e}\DIFaddendFL )&   \DIFdelbeginFL \DIFdelFL{(b3)  }\DIFdelendFL \\
...
(\DIFdelbeginFL \DIFdelFL{c1) }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{f) }& \DIFaddFL{(g)}& \DIFaddendFL \\
\end{tabular}
\caption{ \DIFdelbeginFL \DIFdelFL{The }\DIFdelendFL BDT output distributions \DIFdelbeginFL \DIFdelFL{are fitted with S}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{obtained from a signal}\DIFaddendFL +\DIFdelbeginFL \DIFdelFL{B }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{background fit }\DIFaddendFL to the data \DIFdelbeginFL \DIFdelFL{in }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{for the }\DIFaddendFL $tuH$ search: $t_{\ell}\thadhad$ (\DIFdelbeginFL \DIFdelFL{a1}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{a}\DIFaddendFL ),  $t_{\ell}\tauhad$-1j (\DIFdelbeginFL \DIFdelFL{a2}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{b}\DIFaddendFL ),  $t_{\ell}\tauhad$-2j (\DIFdelbeginFL \DIFdelFL{a3}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{c}\DIFaddendFL ),
  $t_h\tlhad$-2j (\DIFdelbeginFL \DIFdelFL{b1}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{d}\DIFaddendFL ), $t_h\tlhad$-3j (\DIFdelbeginFL \DIFdelFL{b2}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{e}\DIFaddendFL ), $t_h\thadhad$-2j (\DIFdelbeginFL \DIFdelFL{b3}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{f}\DIFaddendFL ), and $t_h\thadhad$-3j (\DIFdelbeginFL \DIFdelFL{c1}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{g}\DIFaddendFL ). \DIFdelbeginFL \DIFdelFL{Statistical }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{The total size of the statistical }\DIFaddendFL and systematic
uncertainties \DIFdelbeginFL \DIFdelFL{are shown}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{is indicated by the hatched band}\DIFaddendFL . The signal shapes \DIFdelbeginFL \DIFdelFL{from }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{of }\DIFaddendFL $tt(uH)$, $tH$, and their sum are also \DIFdelbeginFL \DIFdelFL{compared }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{shown }\DIFaddendFL using a normalisation of $2 \times\BR(t\to uH)$ of 0.1\%. 
}
...
\DIFaddendFL %(b1) BDT in $t_h\tlhad$-2j & (b2) BDT in  $t_h\tlhad$-3j & (b3) BDT in $t_h\thadhad$-2j \\
(\DIFdelbeginFL \DIFdelFL{b1}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{d}\DIFaddendFL ) & (\DIFdelbeginFL \DIFdelFL{b2}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{e}\DIFaddendFL )  &  \DIFdelbeginFL \DIFdelFL{(b3)  }\DIFdelendFL \\
