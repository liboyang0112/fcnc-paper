...
%DIF DEL ../fcnc-paper_20220323/ANA-TOPQ-2019-17-PAPER.tex   Sun Apr 17 20:47:47 2022
...
%DIF 105c105
%DIF < \AtlasVersion{1.2}
%DIF -------
\AtlasVersion{1.3} %DIF > 
%DIF -------
...
%DIF 119c119-120
%DIF < Observed (expected) 95\% CL upper limits are set on the $t\to cH$ and $t\to uH$ branching ratios of $9.9 \times 10^{-4}$ ($5.0^{+2.2}_{-1.4}\times 10^{-4}$) and $7.2\times 10^{-4}$ ($3.6^{+1.7}_{-1.0}\times 10^{-4}$), respectively. 
%DIF -------
Observed (expected) 95\% CL upper limits are set on the $t\to cH$ and $t\to uH$ branching ratios of $9.4 \times 10^{-4}\, (4.8^{+2.2}_{-1.4}\times 10^{-4})$ %DIF > 
and $6.9\times 10^{-4}\, (3.5^{+1.5}_{-1.0}\times 10^{-4})$, respectively.  %DIF > 
%DIF -------
The corresponding combined observed (expected) upper limits on the dimension-6 operator Wilson coefficients in
%DIF 121c122
%DIF < the effective $tqH$ couplings are $C_{c\phi} <1.38\, (0.97)$ and $C_{u\phi} <1.18\, (0.83)$, respectively.}%for the new physics scale $\Lambda$ at 1~TeV, respectively.} 
%DIF -------
the effective $tqH$ couplings are $C_{c\phi} <1.35\, (0.97)$ and $C_{u\phi} <1.16\, (0.82)$, respectively.}%for the new physics scale $\Lambda$ at 1~TeV, respectively.}  %DIF > 
%DIF -------
...
%DIF < \AtlasRefCode{ATLAS-CONF-2022-014}
%DIF -------
...
% Comment deadline
%DIF 165c166
%DIF < \AtlasCoverCommentsDeadline{9 March 2022}
%DIF -------
\AtlasCoverCommentsDeadline{9 May 2022} %DIF > 
%DIF -------
...
depending on four types, three $\pt$ bins, two bins for 1- and 3-prong taus separately. The \DIFaddbegin \DIFadd{post-fit of leading $\thad$ $\pt$ distributions and measured tau scale factors are presented in Appendix~\ref{sec:tauFF_appendix}. 
The }\DIFaddend values of these scale factors range from 0.3-1.28 are then used to correct the MC estimated fakes in the corresponding  signal regions with a single $b$-jet.
...
A comparison between data and the predicted background for the leading $\had$ $\pt$  \DIFdelbegin \DIFdel{distribution in the SRs}\DIFdelend \DIFaddbegin \DIFadd{and the visible invariant mass of the di-tau system ($m_{\tau\tau}$)
distributions in SRs and VRs}\DIFaddend , after applying fake factors, 
%some of these variables in three main decay final states($t_{\ell}\hadhad$, $t_h\hadhad$, and $t_h\lephad$)
\DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{are }\DIFaddend shown in Figure~\ref{fig:taupt_prefit} \DIFaddbegin \DIFadd{and~\ref{fig:mtt}, respectively}\DIFaddend .
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[page=1,width=0.29\textwidth]{figures/new_pt/log_or_nolog/tuH_reg1l2tau1bnj_os_log_.pdf} %%%
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[page=1,width=0.29\textwidth]{figures/new_pt/log_or_nolog/tuH_reg1l1tau1b1j_ss_log_.pdf}%%%
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[page=1,width=0.29\textwidth]{figures/new_pt/log_or_nolog/tuH_reg1l1tau1b2j_ss_log_.pdf}%%%
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[page=1,width=0.29\textwidth]{figures/new_pt/log_or_nolog/tuH_reg1l1tau1b2j_os_log_.pdf}%%%
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[page=1,width=0.29\textwidth]{figures/new_pt/log_or_nolog/tuH_reg1l1tau1b3j_os_log_.pdf}%%%
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[page=1,width=0.29\textwidth]{figures/new_pt/log_or_nolog/tuH_reg2mtau1b2jos_log_.pdf}%%%
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[page=1,width=0.29\textwidth]{figures/new_pt/log_or_nolog/tuH_reg2mtau1b3jos_log_.pdf}%%%
...
\end{tabular}
\caption{\DIFaddFL{Visible invariant mass of di-tau system ($m_{\tau\tau}$) distributions obtained before the fit to data (``Pre-Fit'') showing 
  the expected background and $tuH$ signals after applying fake factors in the following: $t_{\ell}\thadhad$ (a),
...
%DIF > \includegraphics[page=1,width=0.29\textwidth]{figures/ttCR/tuH_reg1l1tau2b2j_os_log_ttCR.pdf} &
%DIF > \includegraphics[page=1,width=0.29\textwidth]{figures/ttCR/tuH_reg1l1tau2b2j_ss_log_ttCR.pdf}&
%DIF > \includegraphics[page=1,width=0.29\textwidth]{figures/ttCR/tuH_reg1l1tau2b3j_os_log_ttCR.pdf}\\
%DIF > (a) & (b) & (c) \\
%DIF > \includegraphics[page=1,width=0.29\textwidth]{figures/ttCR/tuH_reg1l1tau2b3j_ss_log_ttCR.pdf}&
%DIF > \includegraphics[page=1,width=0.29\textwidth]{figures/ttCR/tuH_reg2l1tau1bnj_log_ttCR.pdf}&
%DIF > \includegraphics[page=1,width=0.29\textwidth]{figures/ttCR/tuH_reg2l1tau2bnj_log_ttCR.pdf}\\
%DIF > (d) & (e) & (f)\\
%DIF > \end{tabular}
%DIF > \caption{Leading $\thad$ $\pt$  distributions obtained the fit to data (``Post-Fit'') for the fake $\thad$ fake factor calibration in the following ttCRs: 
%DIF > $t_{\ell}t_{h}$2b$\thad$-2j OS (a), $t_{\ell}t_{h}$2b$\thad$-2j SS (b), $t_{\ell}t_{h}$2b$\thad$-3j OS (c), $t_{\ell}t_{h}$2b$\thad$-3j SS (d), $t_{\ell}t_{\ell}$1b$\thad$-nj (e) and $t_{\ell}t_{\ell}$2b$\thad$-nj (f).
%DIF >  The total size of the statistical and systematic uncertainties of the background prediction is indicated by the hatched band.
%DIF >  Overflow events are included in the last bin. 
%DIF > The lower panels show the data to prediction ratio.}
%DIF > \label{fig:ttCR_mtt}
%DIF > \end{figure}
...
\DIFdelbegin \DIFdel{from the measured values }\DIFdelend %DIF > from the measured values in Ref.~\cite{Zyla:2020zbs}.
\DIFaddbegin \DIFadd{into account following the recommendation }\DIFaddend in Ref.~\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
...
.
}\DIFaddend The uncertainty of ISR, FSR, scale and PDF are considered and are treated fully correlated in all SRs. The parton shower uncertainties are estimated by comparing
...
\begin{tabular}{@{}ccc@{}}
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tuH_reg1l2tau1bnj_os.pdf}%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tuH_reg1l2tau1bnj_os.pdf}\DIFaddendFL &
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tuH_reg1l1tau1b1j_ss.pdf}%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tuH_reg1l1tau1b1j_ss.pdf}\DIFaddendFL &
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tuH_reg1l1tau1b2j_ss.pdf}%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tuH_reg1l1tau1b2j_ss.pdf}\DIFaddendFL \\
%(a1) BDT in $t_{\ell}\thadhad$ & (a2) BDT in  $t_{\ell}\tauhad$-1j& (a3) BDT in $t_{\ell}\tauhad$-2j\\
(a)  & (b) & (c) \\
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tuH_reg1l1tau1b2j_os.pdf}%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tuH_reg1l1tau1b2j_os.pdf}\DIFaddendFL &
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tuH_reg1l1tau1b3j_os.pdf}%%%
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tuH_reg2mtau1b3jos.pdf}%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tuH_reg2mtau1b3jos.pdf}\DIFaddendFL &
\DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tuH_reg2mtau1b3jss.pdf}\DIFaddendFL \\
%(c1) BDT in$t_h\thadhad$-3j\\
%DIF < (g) & (h)  &  \\
...
%DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tcH_reg1l2tau1bnj_os.pdf}%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tcH_reg1l2tau1bnj_os.pdf}\DIFaddendFL &
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tcH_reg1l1tau1b1j_ss.pdf}%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tcH_reg1l1tau1b1j_ss.pdf}\DIFaddendFL &
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tcH_reg1l1tau1b2j_ss.pdf}%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tcH_reg1l1tau1b2j_ss.pdf}\DIFaddendFL \\
%(a1) BDT in $t_{\ell}\thadhad$ & (a2) BDT in  $t_{\ell}\tauhad$-1j& (a3) BDT in $t_{\ell}\tauhad$-2j\\
(a)  & (b) & (c) \\
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tcH_reg1l1tau1b2j_os.pdf}%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tcH_reg1l1tau1b2j_os.pdf}\DIFaddendFL &
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tcH_reg1l1tau1b3j_os.pdf}%%%
...
\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tcH_reg2mtau1b3jos.pdf}%%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tcH_reg2mtau1b3jos.pdf}\DIFaddendFL &
\DIFaddbeginFL \includegraphics[width=0.29\textwidth]{figures/tcH_reg2mtau1b3jss.pdf}\DIFaddendFL \\
%(c1) BDT in$t_h\thadhad$-3j\\
%DIF < (g) & (h)  &  \\
\DIFdelbeginFL \DIFdelFL{(f}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{(g}\DIFaddendFL ) & (\DIFdelbeginFL \DIFdelFL{g}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{h}\DIFaddendFL )  & \DIFaddbeginFL \DIFaddFL{(i) }\DIFaddendFL \\
%DIF > (f) & (g)  &  \\
...
\DIFdelbegin \DIFdel{$\BR(t\to cH)<9.9 \times 10^{-4}\,(5.0^{+2.2}_{-1.4}\times10^{-4})$}\DIFdelend \DIFaddbegin \DIFadd{$\BR(t\to cH)<9.4 \times 10^{-4}\,(4.8^{+2.2}_{-1.4}\times10^{-4})$}\DIFaddend , assuming $\BR(t\to uH)=0$,and \DIFdelbegin \DIFdel{$\BR(t\to uH)<7.2 \times 10^{-4}\,(3.6^{+1.7}_{-1.0}\times10^{-4})$}\DIFdelend \DIFaddbegin \DIFadd{$\BR(t\to uH)<6.9 \times 10^{-4}\,(3.5^{+1.5}_{-1.0}\times10^{-4})$}\DIFaddend , assuming $\BR(t\to cH)=0$.
...
%DIF >  \end{table}
 \begin{center}
   \begin{tabular}{%
    ...
    %DIF < $\tau$ ID                               & 3.3           &4.4         \\
    %DIF < Signal modeling including Br($H\to\tau\tau$)       & 5.3           &7.0         \\\midrule
    Total systematic uncertainty            & \DIFdelbeginFL \DIFdelFL{11.2          }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{10.1          }\DIFaddendFL &\DIFdelbeginFL \DIFdelFL{15.5        }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{14.1        }\DIFaddendFL \\
     Data statistical uncertainty            & \DIFdelbeginFL \DIFdelFL{14.1          }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{14.9          }\DIFaddendFL &\DIFdelbeginFL \DIFdelFL{19.6         }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{19.4        }\DIFaddendFL \\\midrule
...
$C_{q\phi} =\sqrt{(C^{i3}_{q\phi})^2 + (C^{3i}_{q\phi})^2}$~\cite{fcnc_production_theory}. The observed (expected) upper limits on the D6 Wilson coefficients from the combination of the searches are \DIFdelbegin \DIFdel{$C_{c\phi}<1.38\,(0.97)$ and $C_{u\phi}<1.18\,(0.83)$ }\DIFdelend \DIFaddbegin \DIFadd{$C_{c\phi}<1.35\,(0.97)$ and $C_{u\phi}<1.16\,(0.82)$ }\DIFaddend for a new physics scale $\Lambda=1$~TeV. 
...
%DIFDELCMD < $t_h\thadhad$-3j                & $1.18$($1.06^{+0.50}_{-0.30}$)&$0.34$($1.87$)  & $0.16^{+0.47}_{-0.47}$ &$1.00$($0.89^{+0.42}_{-0.25}$)&$0.36$($2.13$)  &$0.14^{+0.40}_{-0.40}$  \\ \midrule
...
%DIFDELCMD < $t_l\thadhad$                   &$1.41$($0.63^{+0.29}_{-0.18}$) &$2.64$($3.24$)   &$0.74^{+0.34}_{-0.34}$  & $1.01$($0.45^{+0.21}_{-0.13}$) & $2.64$($4.08$)  &$0.53^{+0.25}_{-0.25}$\\ \midrule
...
%DIF > \begin{table}
%DIF > \caption{ Summary of fake tau (1-prong) scale factors derived in ttCRs. The numbers are shown as: nominal values,statistical errors and systematics erros. }
%DIF > \begin{center}
%DIF > \begin{tabular}{lcccccc}
%DIF > \toprule\toprule

%DIF > \multirow{2}{*}{Fake Factor Types} & \multicolumn{3}{c}{1 prong}  \\                                                
%DIF >                                    &  $25-35$ GeV  & $35-45$ GeV  &  $45-$ GeV            \\                           
%DIF > \midrule
%DIF > Type-1                          &$0.71 \pm 0.01 \pm 0.03 $ &$0.61 \pm 0.02 \pm 0.04 $ &$0.38 \pm 0.02 \pm 0.05 $  \\
%DIF > % W fake OS       
%DIF > Type-2                          &$0.76 \pm 0.06 \pm 0.04 $ & $0.37 \pm 0.08 \pm 0.02$ & $0.74 \pm 0.08 \pm 0.02 $ \\
%DIF > % W fake SS          
%DIF > Type-3                          &$0.62 \pm 0.10 \pm 0.03 $ &$0.83 \pm 0.09 \pm 0.03 $ &$0.94 \pm 0.07 \pm 0.02 $  \\
%DIF > %  b fake       
%DIF > Type-4                          &$1.20 \pm 0.02 \pm 0.01 $ & $1.01 \pm 0.04 \pm 0.02 $ &$0.76 \pm 0.03 \pm 0.03 $  \\
%DIF > % other fake
%DIF > \bottomrule\bottomrule
%DIF > \end{tabular}
%DIF > \label{tab:ff1_summary}
%DIF > \end{center}
%DIF > \end{table}


%DIF > \begin{table}
%DIF > \caption{ Summary of fake tau (3-prong) scale factors derived in ttCRs. The numbers are shown as: nominal values,statistical errors and systematics erros. }
%DIF > \begin{center}
%DIF > \begin{tabular}{lcccccc}
%DIF > \toprule\toprule

%DIF > \multirow{2}{*}{Fake Factor Types}        & \multicolumn{3}{c}{3 prong}  \\
...
%DIF >                                           &  $25-35$ GeV  & $35-45$ GeV       &  $45-$ GeV  \\
%DIF > \midrule
%DIF > Type-1                                    & $1.01 \pm 0.03 \pm 0.04 $ & $1.09 \pm 0.04 \pm 0.05 $ & $0.30 \pm 0.05 \pm 0.07 $ \\
%DIF > % W fake OS
%DIF > Type-2                                    & $0.93 \pm 0.10 \pm 0.04 $ & $1.05 \pm 0.09 \pm 0.03 $ & $0.79 \pm 0.09 \pm 0.04 $ \\
%DIF > % W fake SS
%DIF > Type-3                                    & $1.07 \pm 0.13 \pm 0.03 $ &$1.39 \pm 0.12 \pm 0.03 $ &$1.26 \pm 0.10 \pm 0.04 $  \\
%DIF > %  b fake
%DIF > Type-4                                    &$1.28 \pm 0.07 \pm 0.02 $ &$0.66 \pm 0.08 \pm 0.01 $ & $0.71 \pm 0.07 \pm 0.02 $ \\
%DIF > % other fake
%DIF > \bottomrule\bottomrule
%DIF > \end{tabular}
%DIF > \label{tab:ff2_summary}
%DIF > \end{center}
%DIF > \end{table}
...
Observed (expected) 95\% CL upper limits are set on the $t\to cH$ and $t\to uH$ branching ratios of \DIFdelbegin \DIFdel{$9.9\times10^{-4}$ ($5.0^{+2.2}_{-1.4}\times10^{-4}$) and $7.2\times10^{-4}$ ($3.6^{+1.7}_{-1.0}\times10^{-4}$}\DIFdelend \DIFaddbegin \DIFadd{$9.4\times10^{-4}$ ($4.8^{+2.2}_{-1.4}\times10^{-4}$) and $6.9\times10^{-4}$ ($3.5^{+1.5}_{-1.0}\times10^{-4}$}\DIFaddend ).
...
The corresponding combined observed (expected) upper limits on the dimension-6 operator Wilson coefficients in
the effective $tqH$ couplings for a new physics scale $\Lambda$ of 1~TeV are \DIFdelbegin \DIFdel{$C_{c\phi} <1.38\, (0.97)$ and $C_{u\phi} <1.18\, (0.83)$}\DIFdelend \DIFaddbegin \DIFadd{$C_{c\phi} <1.35\, (0.97)$ and $C_{u\phi} <1.16\, (0.82)$}\DIFaddend , respectively.
...
\DIFaddend %-------------------------------------------------------------------------------
%DIF < \input{acknowledgements/Acknowledgements}
...
\DIFaddend %The \texttt{atlaslatex} package contains the acknowledgements that were valid
...
\DIFaddend %\part*{Auxiliary Material}
%\addcontentsline{toc}{part}{Appendix}
%\addcontentsline{toc}{part}{Auxiliary Material}
%-------------------------------------------------------------------------------
%In a paper, an appendix is used for technical details that would otherwise disturb the flow of the paper.
%Such an appendix should be printed before the Bibliography.
%DIF < \input{sections/prepostfit_yields_Htautau_appendix}
\DIFaddbegin \section{\DIFadd{Tau fake scale factor calibration in the ttCRs}}
\label{sec:tauFF_appendix}

\DIFadd{Figure~\ref{fig:ttCR_mtt} shows the post-fit of the leading $\thad$ $\pt$ in the ttCRs, which shows a good agreement between the data and the fitted background model.
...
\DIFaddFL{(d) }& \DIFaddFL{(e) }& \DIFaddFL{(f)}\\
\end{tabular}
\caption{\DIFaddFL{Leading $\thad$ $\pt$  distributions obtained after the fit to data (``Post-Fit'') for the $\thad$ fake scale factors in the following ttCRs:
...
\begin{table}
\caption{ \DIFaddFL{Summary of fake tau (1-prong) scale factors derived in the ttCRs. The numbers are shown as: nominal values, statistical, and systematics erros. }}
\begin{center}
\begin{tabular}{lcccccc}
\toprule\toprule

\DIFaddFL{Fake tau types }& \multicolumn{3}{c}{1-prong tau}  \\ \midrule
\DIFaddFL{$\thad$ $\pt$                                   }&  \DIFaddFL{$25-35$ GeV  }& \DIFaddFL{$35-45$ GeV  }&  \DIFaddFL{$45-$ GeV            }\\
\midrule
...
\begin{table}
\caption{ \DIFaddFL{Summary of fake tau (3-prong) scale factors derived in the ttCRs. The numbers are shown as: nominal values, statistical, and systematics erros. }}
\begin{center}
\begin{tabular}{lcccccc}
\toprule\toprule

\DIFaddFL{Fake tau types        }& \multicolumn{3}{c}{3-prong tau}  \\ \midrule
\DIFaddFL{$\thad$ $\pt$                             }&  \DIFaddFL{$25-35$ GeV  }& \DIFaddFL{$35-45$ GeV       }&  \DIFaddFL{$45-$ GeV  }\\
\midrule
