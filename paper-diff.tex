...
%DIF ADD ANA-TOPQ-2019-17-PAPER.tex                     Sun Mar 13 09:37:21 2022
...
%DIF 19c19
%DIF < %\documentclass[CONF, atlasdraft=true, texlive=2016, UKenglish]{\ATLASLATEXPATH atlasdoc}
%DIF -------
...
\DIFdelbegin \DIFdel{In contrast, large enhancements of }\DIFdelend \DIFaddbegin \DIFadd{However, }\DIFaddend these branching ratios \DIFdelbegin \DIFdel{are possible in some scenarios }\DIFdelend \DIFaddbegin \DIFadd{can be as high as $\BR(t\to qH) \sim 10^{-5}$ which incorporate }\DIFaddend beyond the SM \DIFdelbegin \DIFdel{.
...
%DIF < CMS recently updated their search for $tqH$ in the $H\to b\bar{b}$ channel using
%DIF < their full Run 2 data and  set observed(expected) upper limits on $\mathcal{B}(t\to Hu)$ of $7.9\times10^{-4}(1.1\times10^{-3})$ and $\mathcal{B}(t\to Hc)$ of $9.4\times10^{-4}(8.6\times10^{-4})$~\cite{CMS:2021gfa}.
\DIFaddbegin \DIFadd{CMS recently updated their search for $tqH$ in the $H\to b\bar{b}$ channel using
...
.
}\DIFaddend %CMS also recently reported a search for $tqH$ in the $H\rightarrow \gamma\gamma$ mode using the full Run-2 data and set observed(expected) upper limits on $\mathcal{B}(t\to Hu)$ of $1.9\times10^{-4}(3.1\times10^{-4})$ and $\mathcal{B}(t\to Hc)$ of $7.3\times10^{-4}(5.1\times10^{-4})$~\cite{CMS-PAS-TOP-20-007}.
...
The \DIFdelbegin \DIFdel{hdamp }\DIFdelend \DIFaddbegin \DIFadd{$h_{\mathrm{damp}}$ }\DIFaddend parameter (which controls the amount of radiation produced by the parton shower in
POWHEG-BOX v2) is set to 1.5$m_t$ in the nominal case. Alternative samples are generated with \DIFdelbegin \DIFdel{hdamp}\DIFdelend \DIFaddbegin \DIFadd{$h_{\mathrm{damp}}$}\DIFaddend =3$m_t$. The
difference between two samples is treated as one of the systematics as ``$t\bar{t}$ \DIFdelbegin \DIFdel{hdamp}\DIFdelend \DIFaddbegin \DIFadd{$h_{\mathrm{damp}}$}\DIFaddend ''. 
...
\includegraphics[width=0.3\textwidth]{figures/tuH_reg1l1tau1b3j_os.pdf}&\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tuH_reg2mtau1b2jos.pdf}%%%
\DIFdelendFL \\
%DIF > \includegraphics[width=0.3\textwidth]{figures/tcH_reg1l2tau1bnj_ss.pdf}\\
%(b1) BDT in $t_h\tlhad$-2j & (b2) BDT in  $t_h\tlhad$-3j & (b3) BDT in $t_h\thadhad$-2j \\
\DIFdelbeginFL \DIFdelFL{(b1}\DIFdelendFL %DIF > (d) & (e)  & (f) \\
\DIFaddbeginFL \DIFaddFL{(d}\DIFaddendFL ) & (\DIFdelbeginFL \DIFdelFL{b2)}%DIFDELCMD < & %%%
\DIFdelFL{(b3)  }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{e)}\DIFaddendFL \\
...
\includegraphics[width=0.3\textwidth]{figures/tcH_reg1l1tau1b3j_os.pdf}&\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=0.3\textwidth]{figures/tcH_reg2mtau1b2jos.pdf}%%%
\DIFdelendFL \\
%DIF > \includegraphics[width=0.3\textwidth]{figures/tcH_reg1l2tau1bnj_ss.pdf}\\
%(b1) BDT in $t_h\tlhad$-2j & (b2) BDT in  $t_h\tlhad$-3j & (b3) BDT in $t_h\thadhad$-2j \\
\DIFdelbeginFL \DIFdelFL{(b1}\DIFdelendFL %DIF > (d) & (e)  & (f) \\
...
\DIFaddbeginFL \DIFaddFL{(f) }& \DIFaddFL{(g)  }&  \DIFaddendFL \\
\end{tabular}
\caption{ \DIFdelbeginFL \DIFdelFL{The }\DIFdelendFL BDT output distributions \DIFdelbeginFL \DIFdelFL{are fitted with S}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{obtained from a signal}\DIFaddendFL +\DIFdelbeginFL \DIFdelFL{B }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{background fit }\DIFaddendFL to the data \DIFdelbeginFL \DIFdelFL{in }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{for the }\DIFaddendFL $tcH$ search: 
%DIF > $t_{\ell}\thadhad$ (a),  $t_{\ell}\tauhad$-1j (b),  $t_{\ell}\tauhad$-2j (c), $t_h\tlhad$-2j (d), $t_h\tlhad$-3j (e), $t_{\ell}\thadhad$ SS (f), $t_h\thadhad$-2j (g), and $t_h\thadhad$-3j (h), where $t_{\ell}\thadhad$ SS is used for the background validation.
$t_{\ell}\thadhad$ (\DIFdelbeginFL \DIFdelFL{a1}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{a}\DIFaddendFL ),  $t_{\ell}\tauhad$-1j (\DIFdelbeginFL \DIFdelFL{a2}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{b}\DIFaddendFL ),  $t_{\ell}\tauhad$-2j (\DIFdelbeginFL \DIFdelFL{a3}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{c}\DIFaddendFL ), $t_h\tlhad$-2j (\DIFdelbeginFL \DIFdelFL{b1}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{d}\DIFaddendFL ), $t_h\tlhad$-3j (\DIFdelbeginFL \DIFdelFL{b2}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{e}\DIFaddendFL ), $t_h\thadhad$-2j (\DIFdelbeginFL \DIFdelFL{b3}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{f}\DIFaddendFL ), and $t_h\thadhad$-3j (\DIFdelbeginFL \DIFdelFL{c1}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{g}\DIFaddendFL ). 
\DIFdelbeginFL \DIFdelFL{Statistical }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{The total size of the statistical }\DIFaddendFL and systematic
...
\begin{tabular}{cccccc} \toprule\toprule
 & $t_l\tauhad$-1j & $t_l\tauhad$-2j & $t_h\tlhad$-3j &$t_h\tlhad$-2j  & $t_l\thadhad$ \\\midrule
  ...
  $\bar{t}t$             & $281 \pm 14  $  & $195 \pm 24  $  & $7100 \pm 400$  &  $11800 \pm 500$ & $7.7 \pm 2.7  $ \\ \DIFaddbeginFL \midrule
  \DIFaddendFL Total background       & $6200 \pm 170$  & $5480 \pm 100$  & $13820 \pm 140$ &  $20000 \pm 170$ & $339 \pm 27   $ \\  \midrule
...
& $t_{h}\thadhad$-2j & $t_{h}\thadhad$-3j\\\midrule
  ...
  $Z\rightarrow\tau\tau$   & $490 \pm 50  $ & $420 \pm 50  $  \\ \DIFaddbeginFL \midrule
  \DIFaddendFL Total background         & $1040 \pm 35 $ & $1040 \pm 40 $  \\ \midrule
...
These results are dominated by the leptonic channels, which \DIFdelbegin \DIFdel{has }\DIFdelend \DIFaddbegin \DIFadd{have }\DIFaddend a sensitivity a factor of two better than that of the hadronic channels.
...
\DIFdelendFL \DIFaddbeginFL \multicolumn{2}{c}{$\Delta\BR$ [$10^{-5}$]} \DIFaddendFL \\
    ...
    $\tau$ ID                               & 3.3           &4.4         \\
    Luminosity and Pileup                   & 0.9           &1.3         \\    
    \DIFaddbeginFL \DIFaddFL{MC statistics              }& \DIFaddFL{5.1           }&\DIFaddFL{7.0         }\\\DIFaddendFL \midrule
    %Other MC modeling                       & 2.1           &2.9         \\
    %JES and JER                             & 2.4           &3.2         \\
    %Flavour tagging                         & 2.7           &3.7         \\
    %$t\bar{t}$ modeling                     & 2.9           &4.3         \\
