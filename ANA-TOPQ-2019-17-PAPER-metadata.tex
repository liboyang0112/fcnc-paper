...
\AtlasTitle{Search for flavour-changing neutral current $tqH$ of the top quark and the Higgs boson which decays into a pair of $\tau$-leptons
                   in pp collisions at $\sqrt{s}=13~\tev$ with the ATLAS detector\vspace{-0.1em}}
...
\AtlasAbstract{%
A search for flavour-changing neutral current $tqH$ interactions with a top quark, an up-type quark ($q=u, c$), and a
Standard Model Higgs boson is presented. The Higgs boson decays into a pair of $\tau$-leptons, $H\rightarrow \tau^+\tau^-$, is considered.
The search is based on a dataset of $pp$ collisions at $\sqrt{s}=13~\tev$ recorded with the ATLAS detector at the 
Large Hadron Collider and corresponds to an integrated luminosity of 139 fb$^{-1}$.
...
as well as multiple jets and event kinematics are used to separate signal from the background through a multivariate discriminant.  
...
There is an excess of data events observed above background with a significance of 2.6$\sigma$,
