...
\AtlasTitle{Search for flavour-changing neutral current $tqH$ interactions of the top quark and the Higgs boson which decays into a pair of $\tau$-leptons in pp collisions at $\sqrt{s}=13~\tev$ with the ATLAS detector\vspace{-0.1em}}
