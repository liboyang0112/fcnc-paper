...
\item \text{min}($m_{\tau\tau \text{j}}$) is the minimum value of the visible mass of the di-tau candidates (include leptonic tau) and the light-flavour jet system, minimized by choosing different jet, reflecting the invariant masss of the visible FCNC top decaying products.
\item \text{min}($m_{\text{jj}}$) is the minimum value of all the invariant mass of all the light-flavour jet pairs, reflecting the invariant mass of the $W$ boson candidate.
