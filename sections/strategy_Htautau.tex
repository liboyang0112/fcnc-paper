...
Boosted decision trees~\cite{Breiman:1984jka,Friedman:2002we,Freund:1997xna} are used in each SR to improve the separation between signal and background. 
...
\caption{$\Htautau$ search: Comparison of the distribution of the BDT discriminant after preselection between the $\Hc$ (red dashed) and $\Hu$ (blue dotted) signals, 
