...
The contribution of background to the signal regions $t_h\hadhad$ and $t_h\lephad$ channels is reduced by having a kinematic constraints on the di-tau mass and the missing transverse energy in the event~\cite{Chen:2015nta}.
...
are estimated using a kinematic fit. The fit is done by minimising a $\chi^2$ function based on the Gaussian constraints on the Higgs boson mass and the
