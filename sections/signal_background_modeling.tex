...
The signal sample is normalised to the same total cross section as used for the $t\bar{t}\to WbWb$ sample (see discussion below) and
...
while preserving the nominal \ttbin\ cross section of the nominal $\ttbar$ sample. 
