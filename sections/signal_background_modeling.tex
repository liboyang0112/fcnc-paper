...
Samples of $W/Z$+jets events are generated with the {\sherpa}~2.2.1~\cite{Gleisberg:2008ta} generator. 
...
During the statistical analysis, the normalisation of the fake $\tauhad$ background in each SR is allowed to vary unconstrained in the fit to data, as discussed in Section~\ref{sec:results_Htautau}.
