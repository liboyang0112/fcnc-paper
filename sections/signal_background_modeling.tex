...
multijet production, depending on the analysis channel, with $W$+jets production contributing to a lesser extent. The simulation study shows that b-jet faking rate is quite low and the fake $\tauhad$ candidates primarily result from the misidentification of light-quark jets. 
\textbf{Add sentence requested by Xin.}
