...
$b$-tagged jets.  Most of the $\ttbar$+light-jets background in these regions have a charm jet from the hadronic $W$ boson 
...
Figure~\ref{fig:LHD} compares the distribution of the LH discriminant between the $\Hc$ and $\Hu$ signals and the 
$t\bar{t}\to WbWb$ background in each of the analysis regions considered.
...
\caption{$\Hbb$ search: Comparison of the distribution of the LH discriminant after preselection 
