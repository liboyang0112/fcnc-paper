...
of the $\BR(t\to Hu)$ versus $\BR(t\to Hc)$ plane, the discriminant optimised for $\Hc$ is used for both 
...
Figure~\ref{fig:LHD} compares the shape of the LH distribution between the $\Hc$ and $\Hu$ signals and the 
$t\bar{t}\to WbWb$ background in each of the analysis regions considered.
