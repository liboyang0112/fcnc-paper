...
A simultaneous fit to data is made to derive the scale factors for fake taus in MC, which consist of a total of 24 parameters
depending on four types of fake taus, three $\pt$ bins, two bins for 1- and 3-prong taus separately. The post-fit distributions of the
