...
fit to data using several signal-depleted control regions as discussed in Section~\ref{sec:strategy_Htautau}.
...
tau candidates via loosened tau requirements with proper fake factors and partially from MC~\cite{ATLAS-CONF-2021-044}.
