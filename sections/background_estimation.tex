...
that the subleading $\had$ candidate is required to fail the medium $\had$ identification, but it still passes a loose requirement.
...
the ratio of the Data-MC ($\mathrm{real~tau}$) yields in which the $\had$ candidate is passed or failed the medium tau ID selection
...
$t_l\had$ channels where the fake light leptons are important, while they are negligible in other leptonic channels. 
