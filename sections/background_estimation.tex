...
The events with one light lepton, two same-sign $\had$, and one $b$-jet, are also selected as a validation region (VR) for the background estimation in the leptonic channels. 
%-------------------------------------------------------------------------------
...
A closure test is made for the background estimations in the signal depleted low BDT ($<-0.6$) regions.
The data are in good agreement with the background prediction in the
$t_{\ell}\had$ channels where the amount of fake light leptons is significant. However, this background is negligible in other leptonic channels. 
