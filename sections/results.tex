...
and those related to $\ttbin$ and $\ttcin$ modelling based on a comparison with alternative generators (by 0.5 standard deviations or less).
...
The $\Hbb$ and $\Htautau$ searches are combined with the ATLAS searches in 
...
%%%%%%%%%%%%%%%
\begin{table}[t!]
\caption{\small{Summary of 95\% CL upper limits on $\BR(t \to Hc)$ and $\BR(t \to Hu)$, in each case neglecting the other decay mode. Signatures with two same-charge (three) leptons and no $\had$ candidates are denoted as $2\ell$SS ($3\ell$). }}
\begin{center}
\begin{tabular}{lcc}
\toprule\toprule
