...
A slight excess of data events, with a significance of 2.3$\sigma$, is observed above the expected background. This is mainly in the high BDT-score region of the most sensitive channel, $t_{\ell}\thadhad$, as shown in
...
the uncertainties in the measured $H\to \tautau$ branching ratio,
the normalisation and factorisation scales, the $b$-tagging efficiency, the choice of parton shower and hadronisation schemes for $t\bar t$ modelling, and
