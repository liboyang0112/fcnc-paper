...
A slight excess of data is observed above background with a significance of 2.6 $\sigma$, which is mainly in the most sensitive $t_{\ell}\thadhad$ channel in the high BDT score region.
...
\begin{table}[h!]
\caption{List of relative uncertainties on the upper limits of $\BR(t\to qH)$ ($q=u,c$) obtained from the combined fit. The uncertainties are symmetrised for\
...
\begin{center}
  \begin{tabular}{%
    ...
    $\tau$ ID                               & 3.3           &4.4         \\
    Luminosity and Pileup                   & 0.9           &1.3         \\\midrule
    %Other MC modeling                       & 2.1           &2.9         \\
    %JES and JER                             & 2.4           &3.2         \\
    %Flavour tagging                         & 2.7           &3.7         \\
    %$t\bar{t}$ modeling                     & 2.9           &4.3         \\
...
$C_{q\phi} =\sqrt{(C^{i3}_{q\phi})^2 + (C^{3i}_{q\phi})^2}$~\cite{fcnc_production_theory}. The observed (expected) upper limits on the D6 Wilson coefficients from the combination of the searches are $C_{c\phi}<1.38\,(0.97)$ and $C_{u\phi}<1.18\,(0.83)$ for the new physics scale $\Lambda$ at 1~TeV. 
...
\begin{tabular}{cccc} \toprule\toprule
                    & $t_h\thadhad$-2j & $t_h\thadhad$-3j & Combination  \\\midrule
$t\to cH$           & $-1.03^{+1.04}_{-1.04} $ & $0.16^{+0.47}_{-0.47} $  & $0.11^{+0.43}_{-0.43}$  \\
$t\to uH$           & $-0.55^{+0.59}_{-0.59}$ & $0.14^{+0.40}_{-0.40} $  &  $0.04^{+0.34}_{-0.34}$  \\
\bottomrule\bottomrule\\
\end{tabular}

\centering
\begin{tabular}{ccccccc} \toprule\toprule
& $t_{\ell}\tauhad$-2j & $t_{\ell}\tauhad$-1j & $t_h\tlhad$-2j& $t_h\tlhad$-3j & $t_{\ell}\thadhad$ & Combination\\\midrule
$t\to cH$          & $0.81^{2.04}_{-2.04} $ & $0.40^{1.70}_{-1.70} $ & $-1.36^{2.56}_{-2.56} $ & $-0.04^{1.26}_{-1.26} $ & $0.74^{0.34}_{-0.34} $ & $0.68^{0.32}_{-0.32} $\\
$t\to uH$          & $0.57^{1.66}_{-1.66} $ & $0.31^{1.33}_{-1.33} $ & $-0.66^{1.38}_{-1.38} $ & $-0.04^{0.98}_{-0.98} $ & $ 0.53^{0.25}_{-0.25}$ & $0.48^{0.23}_{-0.23} $\\
\bottomrule\bottomrule\\
\end{tabular}
...
\centering
\begin{tabular}{cccc} \toprule\toprule
                    & hadronic & hadronic & Combination  \\\midrule
$t\to cH$           & $0.11^{+0.43}_{-0.43}$ & $0.68^{0.32}_{-0.32}$  & $0.51^{+0.25}_{-0.25} $  \\
$t\to uH$           & $0.04^{+0.34}_{-0.34}$ & $0.48^{0.23}_{-0.23}$  & $0.37^{+0.18}_{-0.18} $  \\
\bottomrule\bottomrule\\
\end{tabular}
...
$\mathcal{B}(t\to cH)$             & $1.85 \times 10^{-3}$  ($2.80^{+1.30}_{-0.78} \times 10^{-3} $ ) & $1.18 \times 10^{-3}$  ($1.06^{+0.50}_{-0.30} \times 10^{-3}$  )  & $1.04 \times 10^{-3}$ ($9.8^{+4.6}_{-2.8} \times 10^{-4}$ )\\
...
$\mathcal{B}(t\to uH)$    & $1.10 \times 10^{-3}$  ($1.65^{+0.79}_{-0.46} \times 10^{-3}$ ) & $1.00 \times 10^{-3}$  ($8.9^{+4.2}_{-2.5} \times 10^{-4}$  )  & $7.8 \times 10^{-4}$ ($7.8^{+3.7}_{-2.2} \times 10^{-4}$ )\\
\bottomrule\bottomrule\\
\end{tabular}
...
\centering
\begin{tabular}{cccc} \toprule\toprule
 & $t_{\ell}\tauhad$-2j & $t_{\ell}\tauhad$-1j & $t_h\tlhad$-2j\\\midrule
...
$\mathcal{B}(t\to cH)$              & $4.86 \times 10^{-3}$  ($4.32^{+1.89}_{-1.21} \times 10^{-3}$  ) & $3.94 \times 10^{-3}$ ($3.67^{+1.66}_{-1.03} \times 10^{-3}$   )& $4.81 \times 10^{-3}$ ($5.85^{+2.90}_{-1.63} \times 10^{-3}$   ) \\
...
$\mathcal{B}(t\to uH)$              & $3.93 \times 10^{-3}$  ($3.55^{+1.56}_{-0.99} \times 10^{-3}$  ) & $3.10 \times 10^{-3}$ ($2.87^{+1.29}_{-0.80} \times 10^{-3}$   )& $2.56 \times 10^{-3}$ ($3.05^{+1.38}_{-0.85} \times 10^{-3}$   ) \\
\bottomrule\bottomrule\\    
\end{tabular}
\begin{tabular}{cccc} \toprule\toprule
 & $t_h\tlhad$-3j & $t_{\ell}\thadhad$ & Combined\\\midrule
...
$\mathcal{B}(t\to cH)$         &$2.78 \times 10^{-3}$ ($2.79^{+1.36}_{-0.78} \times 10^{-3}$   ) & $1.41 \times 10^{-3}$ ($0.63^{+0.29}_{-0.18} \times 10^{-3}$) & $1.29 \times 10^{-3}$ ($0.59^{+0.27}_{-0.17} \times 10^{-3}$)\\
...
$\mathcal{B}(t\to uH)$         &$2.07 \times 10^{-3}$ ($2.09^{+0.94}_{-0.58} \times 10^{-3}$   ) & $1.01 \times 10^{-3}$ ($4.5^{+2.1}_{-1.3} \times 10^{-4}$) & $9.2 \times 10^{-4}$ ($4.2^{+1.9}_{-1.2} \times 10^{-4}$)\\
\bottomrule\bottomrule\\
\end{tabular}
