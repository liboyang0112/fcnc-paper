...
For ditau triggers, the threshold of the leading (trailing) $\tauhad$ candidate is 35 (25)~\gev\ with the medium identification required.
...
Events selected by the $\Htautau$ search are classified into $\lephad$ and $\hadhad$ channels depending on the 
...
the trigger and to have a $\pt$ exceeding the trigger $\pt$ threshold by 1--2~\gev. In addition, its electric charge is required to be of
opposite sign to that of the leading $\tauhad$ candidate.
...
Electric charge & -- & $q_\ell \times q_{\tau_{\mathrm{had,1}}} < 0$ & $q_{\tau_{\mathrm{had,1}}} \times q_{\tau_{\mathrm{had,2}}} < 0$ \\
