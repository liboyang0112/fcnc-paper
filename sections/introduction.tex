...
the Large Hadron Collider (LHC), a comprehensive programme of measurements % of its properties
...
Compared to Run~1, the Run~2 searches (Table~\ref{tab:limits_summary_ref}) benefit from the increased $\ttbar$ cross section at $\sqrt{s}=13~\tev$, as well as the larger integrated luminosity.
