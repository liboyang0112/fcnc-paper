...
On the other hand, if the $tqH$ interaction exists, the single-top, Higgs associated production through this interaction should also be enhanced. So the study on this process will also contribute to the FCNC interaction searches. The $tH$ associated production in the SM is expected to have a small cross section at LHC centre of mass energy~\cite{Greljo:2014dka}.
...
This paper is focused on the decay mode of the Higgs boson into $\tau$-leptons with the complete Run~2 dataset collected in 2015-2018. The corresponding integrated luminosity is 139.0 fb$^{-1}$. Both $\ttbar \to WbHq$ decay and $pp \to tH$ production are targeted and the signals are divided into several final states depending on the production modes and
