...
In the case of the $\Hbb$ search, where the $\ttbar$+HF background plays a prominent role, a more 
...
different control regions (selected with a requirement on either the maximum $\met$ or $\mtw$). 
