...
Finally, the normalisation of the fake $\tauhad$ background in each SR is determined by the data during the fit procedure, and thus so is its uncertainty. 
...
Finally, a 30\% uncertainty is assigned to the signal events with fake $\tauhad$ candidates selected by the $\Htautau$ search.
