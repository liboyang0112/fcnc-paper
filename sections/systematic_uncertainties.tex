...
difference between two samples is treated as a systematic named as ``$t\bar{t}$ $h_{\mathrm{damp}}$''. 
...
The uncertainty of the ABCD method is applied on the normalisation factors for muon and electron respectively including both,
